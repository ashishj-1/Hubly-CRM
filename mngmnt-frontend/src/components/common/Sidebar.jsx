...
const Sidebar = () => {
  ...
  const navClass = useCallback(
    ({ isActive }) => `sidebar-link ${isActive ? "active" : ""}`,
    []
  );
  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <NavLink to="/contact-center" className={navClass}>
        ...
        {/* Admin Only - Chatbot Settings */}
        {isAdmin && (
          <NavLink to="/chatbot-settings" className={navClass}>
